...
import com.pisces.platform.core.utils.DoubleUtils;
...
public class BaseFunction {
    ...
    public static Object plus(Object arg1, Object arg2) {
        switch (getType(arg1)) {
            ...
            case DURATION:
                return durationPlus((DateDur) arg1, arg2);
            case STRING:
    ...
    private static Date dateTimePlus(Date arg1, Object arg2) {
        switch (getType(arg2.getClass())) {
            case DURATION:
                return new Date(arg1.getTime() + ((DateDur) arg2).getTime() * DateUtils.PER_SECOND);
            default:
                break;
        }
        throw new ExpressionException("");
    ...
    private static Object durationPlus(DateDur arg1, Object arg2) {
        switch (getType(arg2.getClass())) {
            case DURATION:
                return new DateDur(arg1.getTime() + ((DateDur) arg2).getTime());
            case DATE_TIME:
    ...
    public static Object minus(Object arg1, Object arg2) {
        switch (getType(arg1.getClass())) {
            ...
            case DURATION:
                return durationMinus((DateDur) arg1, arg2);
            default:
                break;
        }
    ...
    public static Object greater(Object arg1, Object arg2) {
        switch (getType(arg1.getClass())) {
            ...
            case DURATION:
                return durationGreater((DateDur) arg1, arg2);
            case ENUM:
    ...
    private static boolean longGreater(Long arg1, Object arg2) {
        switch (getType(arg2.getClass())) {
            ...
            case DURATION:
                return arg1 > ((DateDur) arg2).getTime();
            case ENUM:
                return arg1 > ((Enum<?>) arg2).ordinal();
            case STRING:
                return arg1 > Long.valueOf((String) arg2);
            default:
                break;
        }
        throw new ExpressionException("");
    ...
    private static boolean doubleGreater(Double arg1, Object arg2) {
        switch (getType(arg2.getClass())) {
            ...
            case DOUBLE:
                return DoubleUtils.isLess((Double) arg2, arg1);
            case DURATION:
                return DoubleUtils.isGreater(arg1, ((DateDur) arg2).getTime());
            case ENUM:
                return DoubleUtils.isGreater(arg1, ((Enum<?>) arg2).ordinal());
            case STRING:
                return DoubleUtils.isLess(Double.valueOf((String) arg2), arg1);
            default:
                break;
        }
        throw new ExpressionException("");
    ...
    private static boolean durationGreater(DateDur dur, Object arg2) {
        switch (getType(arg2)) {
            ...
            case DURATION:
                return dur.getTime() > ((DateDur) arg2).getTime();
            case STRING:
                return dur.getTime() > new DateDur((String) arg2).getTime();
            default:
                break;
        }
        throw new ExpressionException("");
    ...
    private static boolean stringGreater(String arg1, Object arg2) {
        switch (getType(arg2.getClass())) {
            case LONG:
                return Long.valueOf(arg1) > (long) arg2;
            case DOUBLE:
                return DoubleUtils.isGreater(Double.valueOf(arg1), (double) arg2);
            case DATE_TIME:
                break;
            case DURATION:
                return new DateDur(arg1).getTime() > ((DateDur) arg2).getTime();
    ...
    private static boolean doubleGreaterEqual(Double arg1, Object arg2) {
        switch (getType(arg2.getClass())) {
            ...
            case DOUBLE:
                return DoubleUtils.isLessEqual((Double) arg2, arg1);
            case STRING:
                return DoubleUtils.isLessEqual(Double.valueOf((String) arg2), arg1);
            default:
                break;
        }
        throw new ExpressionException("");
    ...
    private static boolean longEqual(Long arg1, Object arg2) {
        switch (getType(arg2.getClass())) {
            ...
            case STRING:
                return arg1.equals(Long.valueOf((String) arg2));
            default:
                break;
        }
        throw new ExpressionException("");
    ...
    private static boolean doubleEqual(Double arg1, Object arg2) {
        switch (getType(arg2.getClass())) {
            ...
            case DOUBLE:
                return DoubleUtils.isEqual(arg1, (Double) arg2);
            case DURATION:
                return DoubleUtils.isEqual(arg1, ((DateDur) arg2).getTime());
            case ENUM:
                return DoubleUtils.isEqual(arg1, ((Enum<?>) arg2).ordinal());
            case MULTI_ENUM:
                return DoubleUtils.isEqual(arg1, ((MultiEnum<?>) arg2).getValue());
            case STRING:
                return DoubleUtils.isEqual(arg1, Double.valueOf((String) arg2));
            default:
                break;
        }
        throw new ExpressionException("");
    ...
    private static boolean stringEqual(String arg1, Object arg2) {
        switch (getType(arg2.getClass())) {
            case LONG:
                return Long.valueOf(arg1) == (long) arg2;
            case DOUBLE:
                return DoubleUtils.isEqual(Double.valueOf(arg1), (double) arg2);
            case ENUM:
                break;
            case STRING:
                return arg1.compareTo((String) arg2) == 0;
